...
import thingy.internalProjectSupport.Version;
...
public class GivenCodeVersion implements Serializable {
    ...
    final static private long encodedGivenCodeVersion = 2___00001_002___2022_06_09__01L;  // <<<=== !!! GIVEN CODE VERSION !!!
    final static private long encodedOwnClassVersion  = 2___00001_003___2022_05_31__01L;
    //--------------------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
